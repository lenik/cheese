...
namespace Cheese
{
  ...
  public class Camera : GLib.Object
  {
    ...
    public void                        set_lux_red (double value);
    public void                        set_lux_yellow (double value);
    public void                        set_lux_green (double value);
    public void                        set_lux_cyan (double value);
