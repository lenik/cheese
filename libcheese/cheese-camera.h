...
void cheese_camera_set_lux_red (CheeseCamera *camera, gdouble value);
void cheese_camera_set_lux_yellow (CheeseCamera *camera, gdouble value);
void cheese_camera_set_lux_green (CheeseCamera *camera, gdouble value);
void cheese_camera_set_lux_cyan (CheeseCamera *camera, gdouble value);
